...
graph LR
    ...
    subgraph "plugins/claude-code"
        ...
        SKILL["Skills:<br/>memory-recall · memory-search · memory-expand<br/>session-recall · memory-stats · config-check"]
    end
